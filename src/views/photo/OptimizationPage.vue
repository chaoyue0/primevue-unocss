...
import test11 from '@/image/testPreload/img.png';
import test12 from '@/image/testPreload/img_1.png';
import test13 from '@/image/testPreload/img_2.png';
import test14 from '@/image/testPreload/img_3.png';
import test15 from '@/image/testPreload/img_4.png';
import test16 from '@/image/testPreload/img_5.png';
import test17 from '@/image/testPreload/img_6.png';
import test10 from '@/image/testPreload/test10.png';
import test9 from '@/image/testPreload/test9.png';
import test8 from '@/image/testPreload/test8.png';
import test7 from '@/image/testPreload/test7.png';
import test6 from '@/image/testPreload/test6.png';
import test5 from '@/image/testPreload/test5.jpg';
import test4 from '@/image/testPreload/test4.jpg';
import test3 from '@/image/testPreload/test3.jpg';
import test2 from '@/image/testPreload/test2.jpg';
import test1 from '@/image/testPreload/test1.jpg';
